...
//   Buffer/Uint8Array crosses as Dart Uint8List (copied,
//   returns as a fresh Uint8Array) and GeoPoint,
//   DocumentReference, FieldValue and VectorValue pass
 ...
 */
export function addDays(start: Timestamp, days: number): Timestamp;
 ...
 */
export function createNote(title: string, options: { createdAt: Timestamp; tags?: string[] | null }): Note;
